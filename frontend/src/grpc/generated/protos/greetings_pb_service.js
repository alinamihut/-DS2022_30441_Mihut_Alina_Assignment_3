...
var src_grpc_protos_greetings_pb = require("../../../grpc/src/grpc/protos/greetings_pb");
...
ChatService.ReceiveMessages = {
  ...
  requestStream: false,
  responseStream: true,
  requestType: src_grpc_protos_greetings_pb.Request,
  responseType: src_grpc_protos_greetings_pb.Message
};
